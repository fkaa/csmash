/**
 * @file
 * @brief Implementation of ComPenDriveController class. 
 ...
 * Default constructor. 
 */
ComPenDriveController::ComPenDriveController() : ComController() {
}
 ...
 */
ComPenDriveController::ComPenDriveController( Player *parent ) {
  m_parent = parent;
 ...
 */
bool
ComPenDriveController::SetTargetX( Player *opponent ) {
  double width;
